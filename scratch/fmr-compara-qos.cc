...
main(int argc, char* argv[])
{
    ...
    nrHelper->SetGnbPhyAttribute("Pattern", StringValue("DL|DL|DL|DL|DL|DL|DL|DL|DL|DL|"));
    nrHelper->SetUePhyAttribute("Pattern", StringValue("DL|DL|DL|DL|DL|DL|DL|DL|DL|DL|"));
